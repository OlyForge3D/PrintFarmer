...
non-secret deployment default used to pre-populate Spoolman in the first-run
wizard. Once setup is complete it returns `404`; the full Spoolman settings
section remains authenticated at all times.
