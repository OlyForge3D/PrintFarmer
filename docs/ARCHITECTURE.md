...
Both ports, and the scheduler/executor/replay-store trio as a whole, must remain unregistered in dependency injection until these upstream adapters land.
