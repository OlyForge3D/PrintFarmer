...
<!-- squad:capabilities schema=1 specialists=16 taskTypes=15 hints=0 -->
...
| --- | --- | --- | --- |
| 🏗️ Dallas | Lead | review | C#/.NET architecture, system design, code review, technical decision-making |
| ⚛️ Ripley | Frontend Dev | advisory | React 19, TypeScript, Tailwind CSS, SignalR client, TanStack Query, Vitest |
| 🔧 Lambert | Backend Dev | advisory | C# 14, .NET 10, ASP.NET Core, Entity Framework Core, SignalR, backend plugins |
| 📱 Hudson | iOS Developer | advisory | iOS Developer |
| 🌐 Gorman | iOS Networking | advisory | iOS Networking & API Integration Specialist |
| 🧪 Kane | Tester | advisory | xUnit, Vitest, React Testing Library, integration testing, FluentAssertions |
| 📝 Ash | Documentation Specialist | advisory | API documentation, user guides, README maintenance, OpenAPI/Swagger, technical writing, changelog m… |
| 🔍 Brett | Researcher | advisory | Competitive analysis, market research, feature discovery, UX benchmarking, 3D printing ecosystem kn… |
| ⚙️ Parker | DevOps & Deployment Engineer | edit | Docker, Docker Compose, CI/CD pipelines, deployment automation, infrastructure design, install scri… |
| 🎨 Newt | Designer (Industrial UI) | advisory | — |
| 🔍 Bishop | Code Reviewer (Claude Opus 5) | review | Code Reviewer |
| 🔍 Hicks | Code Reviewer (GPT-5.6 Sol) | review | Code Reviewer |
| 🔍 Vasquez | Code Reviewer (Gemini 3.1 Pro Preview) | review | Code Reviewer |
| ⚛️ Drake | Frontend Dev | advisory | — |
| 📋 Scribe | Session Logger | advisory | — |
| 🔄 Ralph | Work Monitor | advisory | — |

### Supported task types

Lead, Frontend Dev, Backend Dev, iOS Developer, iOS Networking, Tester, Documentation Specialist, Researcher, DevOps & Deployment Engineer, Designer (Industrial UI), Code Reviewer (Claude Opus 5), Code Reviewer (GPT-5.6 Sol), Code Reviewer (Gemini 3.1 Pro Preview), Session Logger, Work Monitor
...
- **Can:** review code and pull requests; write and modify code; write and run tests; write and maintain documentation; cut releases and publish packages; author and maintain CI/CD workflows; UX and visual design; deploy to live environments
- **Cannot (no agent claims this):** security and secrets review; responsible-AI and content-safety review
