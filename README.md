...
- **[Ralph Native Role Setup](./docs/ralph-macos-migration.md)** - Mini coordinator, native Mac/Windows consumers, private queue and explicit policy/cutover approval
