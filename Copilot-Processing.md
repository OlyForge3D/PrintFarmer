...
- [x] Commit and push with exact SHA tracking (initial head `467787169bb49183e5e3ae20c81de9cd58a4a80a`; follow-ups `25e4a3ef0c9dec7c9ccc9c36966a845f3150fe01`, `ecf0ed27d67c77f52d108d3957a0aafbafd029e1`, and `d54d9a3a8721aa3232261bf1da9fd556ce3dc5c9`; final follow-up pending commit).
...
- Final hardening: accumulated streamed print durations as `double` hours to avoid cumulative tick overflow and asserted date-range filtering for `TotalPrintHours`; focused tests: 22 passed; full solution build: 0 warnings, 0 errors.
