...
declare -a IMAGES=(
    ...
    "mcr.microsoft.com/dotnet/aspnet:9.0-bookworm-slim|Dockerfile.base-aspnet|aspnet-9.0-bookworm-slim-upgraded"
    "mcr.microsoft.com/dotnet/sdk:9.0|Dockerfile.base-sdk|dotnet-sdk-9.0-upgraded"
...
echo "  4. Run: docker load -i aspnet-9.0-bookworm-slim-upgraded.tar"
echo "  5. Run: docker load -i dotnet-sdk-9.0-upgraded.tar"
