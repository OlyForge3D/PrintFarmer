...
4. Open a draft PR: prefer the app's `create_pull_request` tool (title/body as above), then
   `gh pr edit <num> --add-label squad`. Fall back to `gh pr create --draft --label squad
