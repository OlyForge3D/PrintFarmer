...
- **Blockers:**
  1. Tokenless Dashboard publish/activation order issues
  2. Activation nonce/currentLease race conditions
  3. Missing direct auth/runtime-switch proof
...
**Correction Notice:** Prior entry at 2026-07-20T10:49:02Z incorrectly enumerated Bishop as a *locked agent* for #782.

**Authoritative Clarification:**
- Bishop **is NOT locked** on #782
- Bishop remains a **mandatory independent reviewer**
- Bishop is **required** for Anvil's exact-SHA unified re-review cycle
