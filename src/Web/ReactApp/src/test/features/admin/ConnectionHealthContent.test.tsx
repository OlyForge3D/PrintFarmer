...
const mockResponse: ConnectionDiagnosticsResponse = {
  printers: [
    {
...
vi.mock('../../../services/api', () => ({
  apiClient: {
    getConnectionDiagnostics: vi.fn().mockResolvedValue(mockResponse),
  },
}));
...
describe('ConnectionHealthContent', () => {
  ...
  it('renders summary cards with correct counts', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('1')).toBeInTheDocument(); // Connected or Offline
    });
