...
export function HarvestOperationDetails({ operation, onClose }: HarvestOperationDetailsProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-pf-bg-0 rounded-lg shadow-lg max-w-lg w-full p-6 relative">
        <button
