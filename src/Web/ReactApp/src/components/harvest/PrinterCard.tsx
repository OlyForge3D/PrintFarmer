...
export const PrinterCard: React.FC<PrinterCardProps> = ({
  ...
  return (
    <div
      className={`bg-pf-bg-1 border border-pf-border rounded-xl hover:shadow-lg transition-all duration-200 flex flex-col h-full w-full focus:outline-none focus:ring-2 focus:ring-pf-accent ${compact ? 'gap-1 p-3 text-xs' : 'gap-3 p-5 text-base'}`}
      tabIndex={0}
      role="group"
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <button
          className="text-pf-text-secondary hover:text-pf-accent focus:outline-none"
          ...
          <div className="flex flex-wrap gap-2 items-center text-xs">
            <label className="flex items-center gap-1">
              ...
              <select
                ...
                className="px-2 py-1 rounded-lg bg-pf-panel border border-pf-border focus:outline-none focus:ring-2 focus:ring-pf-accent text-pf-text-primary text-xs"
              >
        ...
        return (
          <div className={`bg-red-50 border border-red-300 rounded-lg p-2 ${compact ? 'mb-1' : 'mb-2'}`}>
            <div className="flex items-start gap-2">
              <ErrorIcon type={errorInfo.iconType} className={compact ? 'w-3 h-3 text-red-600 flex-shrink-0' : 'w-4 h-4 text-red-600 flex-shrink-0'} />
              <div className="flex-1 min-w-0">
                ...
                <p className={`text-red-700 break-words ${compact ? 'text-[9px] mt-0.5' : 'text-xs mt-1'}`}>
                  {errorInfo.message}
                </p>
