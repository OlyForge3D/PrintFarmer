...
describe('PrinterBedVisualization Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders error message when printerModel is missing', () => {
      render(
        <PrinterBedVisualization printerModel={null as any} status={testStatus} />
      );
    ...
    it('renders error message when status is missing', () => {
      render(
        <PrinterBedVisualization printerModel={testPrinterModel} status={null as any} />
      );
  ...
  describe('Error Handling', () => {
    it('displays error state when props are invalid', () => {
      render(
        <PrinterBedVisualization printerModel={undefined as any} status={testStatus} />
      );
