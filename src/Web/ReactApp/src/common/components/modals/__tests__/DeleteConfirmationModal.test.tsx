...
describe("DeleteConfirmationModal", () => {
  ...
  it("should render when isOpen is true", () => {
    ...
    expect(
      screen.getByRole("heading", { name: /Delete Printer/i }),
    ).toBeInTheDocument();
  });
  ...
  it("should show single printer confirmation message", () => {
    ...
    expect(
      screen.getByText(/Are you sure you want to delete "Test Printer"/),
    ).toBeInTheDocument();
    expect(
  ...
  it("should show multiple printers confirmation message", () => {
    ...
    expect(
      screen.getByText(/Are you sure you want to delete 3 printers/),
    ).toBeInTheDocument();
  ...
  it("should show correct button text for single printer", () => {
    ...
    expect(
      screen.getByRole("button", { name: /Delete Printer/i }),
    ).toBeInTheDocument();
  });
