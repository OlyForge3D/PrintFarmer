...
export function TasksBadge() {
  ...
  return (
    ...
    >
      ...
      <span data-pf-radius="full" className="absolute -top-1 -right-1 inline-flex items-center justify-center h-4 min-w-4 px-1 text-[10px] font-bold leading-none text-[var(--pf-text-inverse)] bg-pf-warning rounded-full">
        {count > 9 ? '9+' : count}
      </span>
    </Link>
  );
