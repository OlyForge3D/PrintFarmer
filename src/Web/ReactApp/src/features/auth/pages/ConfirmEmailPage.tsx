    ...
    <div className="min-h-screen flex items-center justify-center bg-pf-bg-1 px-4">
      <div className="max-w-md w-full bg-pf-bg-0 border border-pf-border rounded-lg shadow-lg p-8">
        <div className="text-center">
          ...
          {status === 'success' && (
            <>
              <div className="mx-auto w-16 h-16 mb-4 flex items-center justify-center rounded-full" style={{ backgroundColor: 'var(--pf-success-bg)', opacity: 0.1 }}>
                <svg className="w-10 h-10" style={{ color: 'var(--pf-success)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {status === 'error' && (
            <>
              <div className="mx-auto w-16 h-16 mb-4 flex items-center justify-center rounded-full" style={{ backgroundColor: 'var(--pf-error)', opacity: 0.1 }}>
                <svg className="w-10 h-10" style={{ color: 'var(--pf-error)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
