...
export function EmailConfirmationBanner() {
  ...
  return (
    <div className="border-b border-pf-border bg-pf-bg-2">
      <div className="max-w-7xl mx-auto py-3 px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between flex-wrap">
          <div className="flex items-center flex-1">
            <span className="flex p-2 rounded-lg bg-pf-bg-1">
              <EmailIcon className="h-5 w-5 text-pf-warning" />
            </span>
          ...
          <div className="order-3 mt-2 shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto space-x-2 flex items-center">
            <Button
              ...
              disabled={sending}
              className="flex items-center justify-center bg-pf-bg-1 enabled:hover:bg-pf-bg-0 text-pf-warning"
