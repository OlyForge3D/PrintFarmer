...
import { SlicerSettingsPanel, DEFAULT_SIMPLE_SETTINGS, type SimpleSlicerSettings } from '@/features/slicer/components/settings';
...
export const OrcaSlicerPage: React.FC = () => {
  ...
  const [slicerSettings, setSlicerSettings] = useState<SimpleSlicerSettings>(DEFAULT_SIMPLE_SETTINGS);
  ...
  // === Handlers ===
  const handleSlicerSettingsChange = useCallback((newSettings: SimpleSlicerSettings) => {
