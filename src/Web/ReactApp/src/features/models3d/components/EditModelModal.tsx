...
import { CheckIcon, ChevronDownIcon, ChevronRightIcon, PlusIcon, DeleteIcon } from '@/common/components/icons/MdiIcons';
...
import { 
  NozzleType, NozzleTypeLabels, 
  ToolheadType, ToolheadTypeLabels
} from '@/types/api';
