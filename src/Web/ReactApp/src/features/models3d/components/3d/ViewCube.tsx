    ...
    <div className="absolute top-4 right-4 z-10 bg-pf-bg-0/90 rounded-lg shadow-lg p-2 border border-pf-border">
      ...
      <div className="grid grid-cols-3 gap-1 mb-1">
        ...
        <button
          ...
          className="w-6 h-6 bg-pf-accent-bg hover:bg-pf-accent-hover text-[var(--pf-on-accent)] text-xs font-bold rounded-sm flex items-center justify-center transition-colors cursor-pointer"
          title="Top View"
        >
          T
        </button>
