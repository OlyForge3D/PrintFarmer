        ...
        return (
          <Button
            ...
            className={clsx(
              ...
              isActive
                ? "bg-pf-accent-bg text-[var(--pf-on-accent)] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.16)] enabled:hover:ring-1 enabled:hover:ring-inset enabled:hover:ring-[var(--pf-on-accent)]"
