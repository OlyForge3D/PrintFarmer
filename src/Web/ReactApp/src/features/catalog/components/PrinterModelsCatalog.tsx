...
import { CloseIcon, EditIcon, DeleteIcon, SaveIcon, ImageIcon, PlusIcon, CopyIcon } from '@/common/components/icons/MdiIcons';
...
/**
 * PrinterModelsCatalog - Manages printer manufacturers and models
 * Extracted from CatalogPage to support tabbed catalog interface
 */
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-pf-text-secondary">Loading printers catalog...</div>
      </div>
    );
  }
