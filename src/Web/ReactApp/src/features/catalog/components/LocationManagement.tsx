...
import { Location, LocationTreeNode, CreateLocationRequest, UpdateLocationRequest, locationService } from '@/services/locationService';
      ...
      {showForm && (
        <div className="shadow-sm rounded-lg p-6 bg-pf-bg-1 border border-pf-border max-w-4xl">
          ...
          <form onSubmit={handleCreateOrUpdate} className="space-y-4">
            <div>
              <label htmlFor="loc-name" className="block text-sm font-medium text-pf-text-primary">
                Location Name *
              </label>
              <input
                id="loc-name"
            ...
            <div>
              <label htmlFor="loc-desc" className="block text-sm font-medium text-pf-text-primary">
                Description
              </label>
              <Textarea
                id="loc-desc"
