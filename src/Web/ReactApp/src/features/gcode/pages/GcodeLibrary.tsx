...
import { Input, Select, FormField, Alert } from '@/common/components/ui';
import { FolderIcon } from '@/common/components/icons/MdiIcons';

export const GcodeLibrary: React.FC = () => {
  ...
  useEffect(() => {
    ...
    apiClient.queryGcodeLibrary(search || undefined)
      .then(allFiles => {
        // Show all files regardless of source (harvested, uploaded, generated)
  ...
  return (
    <PageTemplate
      ...
      subtitle="Browse and manage all G-code files"
      icon={FolderIcon}
      maxWidth="max-w-7xl"
    >
