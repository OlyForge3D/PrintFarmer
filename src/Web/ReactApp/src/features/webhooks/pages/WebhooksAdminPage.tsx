...
import { Button, Input, FormField, Alert, Toggle, Checkbox } from '@/common/components/ui';
    ...
    >
      {webhooks && webhooks.length === 0 ? (
        <div className="text-center py-12 text-pf-text-secondary">
          <ExternalLinkIcon className="w-12 h-12 mx-auto mb-4 opacity-40" />
          <p className="text-lg font-medium">No webhooks configured</p>
          <p className="mt-1">Add a webhook to receive event notifications via HTTP POST.</p>
                ...
                <tr key={d.id} className="border-b border-pf-border/50">
                  ...
                  <td className="py-2 px-2">
                    {d.success ? (
                      ...
                      <span className="text-red-500 text-xs" title={d.errorMessage ?? undefined}>
