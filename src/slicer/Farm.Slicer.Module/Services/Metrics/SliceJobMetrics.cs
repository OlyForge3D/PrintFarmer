...
public sealed class SliceJobMetrics : IDisposable
{
    ...
    /// <summary>Gets the counter for completed jobs that included log artifacts.</summary>
    public Counter<long> JobsCompletedWithLogTotal { get; }

    /// <summary>Gets the histogram for artifacts per job.</summary>
    public Histogram<int> ArtifactsPerJobHistogram { get; }

    /// <summary>Gets the counter for timed-out jobs.</summary>
    public Counter<long> JobsTimedOutTotal { get; }

    /// <summary>Gets the counter for job retries.</summary>
    public Counter<long> JobRetriesTotal { get; }

    /// <summary>
    /// Initializes a new instance of the <see cref="SliceJobMetrics"/> class.
    /// </summary>
    ...
    /// <summary>Record a job timeout event.</summary>
    public void RecordJobTimedOut()
    {
        JobsTimedOutTotal.Add(1);
    }

    /// <summary>Record a job retry event.</summary>
