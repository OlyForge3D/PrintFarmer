...
{
    /// <summary>Broadcast event when a job is queued.</summary>
    ...
    /// <summary>Broadcast event when a job starts processing.</summary>
    ...
    /// <summary>Broadcast progress update for a running job.</summary>
    ...
    /// <summary>Broadcast event when a job completes successfully.</summary>
    ...
    /// <summary>Broadcast event when a job fails.</summary>
    ...
    /// <summary>Broadcast event when a job is cancelled.</summary>
