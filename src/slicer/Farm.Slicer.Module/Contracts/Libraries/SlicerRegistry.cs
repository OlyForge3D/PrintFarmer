...
public class SlicerRegistry : ISlicerRegistry
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SlicerRegistry"/> class.
    /// </summary>
    /// <param name="libraries">All registered slicer library instances.</param>
    /// <param name="uiProviders">All registered UI provider instances.</param>
