...
/// <see cref="Farm.Api.Services.PrintQueue.PrintJobManagementService"/> (moved as-is, no
...
/// slice-to-print bridge controller (<see cref="Farm.Web.Api.Controllers.SlicePrintBridgeController"/>).
...
public sealed class PrintQueueApiModule : IApiModule
{
    ...
    public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        _ = services.AddScoped<Farm.Infrastructure.Services.Interfaces.IPrintJobManagementService, Farm.Api.Services.PrintQueue.PrintJobManagementService>();
    }
