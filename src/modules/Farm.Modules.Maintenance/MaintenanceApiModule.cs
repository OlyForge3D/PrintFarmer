...
/// <see cref="Farm.Web.Api.Services.Maintenance.MaintenanceResolutionNotifier"/> services, the
/// <see cref="Farm.Web.Api.Services.Maintenance.PrintStatsSyncHostedService"/> background
/// sync job, and the <see cref="Farm.Web.Api.Hubs.MaintenanceHub"/> SignalR hub. This is the
...
public sealed class MaintenanceApiModule : IApiModule
{
    ...
    {
        _ = services.AddScoped<Farm.Infrastructure.Services.Maintenance.IMaintenanceAlertService, Farm.Web.Api.Services.Maintenance.MaintenanceAlertEngine>();
        _ = services.AddScoped<Farm.Infrastructure.Services.Maintenance.IMaintenanceResolutionNotifier, Farm.Web.Api.Services.Maintenance.MaintenanceResolutionNotifier>();
        ...
        _ = services.AddHostedService<Farm.Web.Api.Services.Maintenance.PrintStatsSyncHostedService>();
    }
    ...
    public void MapEndpoints(IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapHub<Farm.Web.Api.Hubs.MaintenanceHub>("/hubs/maintenance");
    }
}
