...
public class PartInventoryAdjustmentConfiguration : IEntityTypeConfiguration<PartInventoryAdjustment>
{
    public void Configure(EntityTypeBuilder<PartInventoryAdjustment> builder)
    {
        ...
        {
            _ = table.HasCheckConstraint("CK_PartInventoryAdjustments_Delta_NonZero", "\"Delta\" <> 0");
            _ = table.HasCheckConstraint(
                "CK_PartInventoryAdjustments_ResultingBalance_NonNegative",
                "\"ResultingBalance\" >= 0");
        });
        _ = builder.HasKey(a => a.Id);
        _ = builder.Property(a => a.Delta).IsRequired();
        _ = builder.Property(a => a.ResultingBalance).IsRequired();
