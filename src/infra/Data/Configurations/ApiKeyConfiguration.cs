...
public class ApiKeyConfiguration : IEntityTypeConfiguration<ApiKey>
{
    public void Configure(EntityTypeBuilder<ApiKey> builder)
    {
        ...
        // Purpose/Scopes default to General/None so existing rows never gain desktop
        // access implicitly when these columns are introduced (see issue #837/#839).
        _ = builder.Property(a => a.Purpose).IsRequired().HasConversion<int>().HasDefaultValue(ApiKeyPurpose.General);
