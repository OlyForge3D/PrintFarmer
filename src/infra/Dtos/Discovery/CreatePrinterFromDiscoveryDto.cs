...
public class CreatePrinterFromDiscoveryDto : DiscoveryPrinterInfoDto
{
    ...
    public static CreatePrinterFromDiscoveryDto FromDiscovered(
        ...
        new()
        {
            ...
            FirmwareFamily = discovered.FirmwareFamily,
            GcodeDialect = discovered.GcodeDialect,
            FirmwareDetectionSource = discovered.FirmwareDetectionSource,
            FirmwareVersion = discovered.FirmwareVersion,
            FirmwareDetectionVersion = discovered.FirmwareDetectionVersion,
            FirmwareDetectionConfidence = discovered.FirmwareDetectionConfidence,
            FirmwareDetectedAtUtc = discovered.FirmwareDetectedAtUtc,
