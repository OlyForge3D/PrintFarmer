...
public interface ISlicerOrchestrator
{
    ...
    /// </summary>
    /// <param name="request">The slicing job request containing input parameters.</param>
    /// <param name="cancellationToken">Cancellation token to cancel the operation.</param>
...
public interface ISlicerProgressNotifier
{
    ...
    /// </summary>
    /// <param name="job">The completed slice job.</param>
    /// <param name="result">The slicing result containing output data.</param>
    /// <param name="cancellationToken">Cancellation token to cancel the operation.</param>
    ...
    /// </summary>
    /// <param name="job">The failed slice job.</param>
    /// <param name="errorMessage">The error message describing the failure.</param>
    /// <param name="cancellationToken">Cancellation token to cancel the operation.</param>
