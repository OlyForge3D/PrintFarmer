...
/// </summary>
/// <remarks>
/// Existing and unscoped keys always default to <see cref="General"/> so that they never
...
/// carry. General-purpose keys must never carry any scope other than <see cref="None"/>.
/// </summary>
[Flags]
[JsonConverter(typeof(JsonStringEnumConverter))]
public enum ApiKeyScope
{
    /// <summary>No scopes granted. The only valid value for <see cref="ApiKeyPurpose.General"/> keys.</summary>
    None = 0,
