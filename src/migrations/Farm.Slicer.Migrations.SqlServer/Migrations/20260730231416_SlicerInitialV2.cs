    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DeclaredSha256 = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                ...
                PromotionCheckpointId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                PromotionStartedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                PromotedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                PromotedGcodeFileId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                CleanupReservationToken = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                CleanupReservedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                CleanupDeletionStartedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                SlicerDistribution = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ProfileFormat = table.Column<string>(type: "nvarchar(max)", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ClientUploadId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ClientUploadHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                ...
                SourceLicense = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                SourceCreator = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                SlicerEngineVersion = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                ...
                ModelSha256 = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                ...
                IdempotencyScopeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValue: Guid.Empty),
                ...
                PinnedWorkerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                SlicerBinarySha256 = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                ModelTransformJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                ModelFileTransformsJson = table.Column<string>(type: "nvarchar(max)", nullable: true)
            },
            constraints: table =>
            {
