    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                PartInventoryId = table.Column<Guid>(type: "TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AggregateRowVersion = table.Column<byte[]>(type: "BLOB", nullable: true),
                JobRevision = table.Column<long>(type: "INTEGER", nullable: true),
                PrinterId = table.Column<Guid>(type: "TEXT", nullable: true),
                ProjectId = table.Column<Guid>(type: "TEXT", nullable: true),
                CalibrationAttemptId = table.Column<Guid>(type: "TEXT", nullable: true),
                JobStatus = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                JobKind = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                PrinterConfigRevision = table.Column<long>(type: "INTEGER", nullable: true),
                DispatchStateRowVersion = table.Column<byte[]>(type: "BLOB", nullable: true),
                DispatchStateRevision = table.Column<long>(type: "INTEGER", nullable: true),
                AttemptId = table.Column<Guid>(type: "TEXT", nullable: true),
                AttemptNumber = table.Column<int>(type: "INTEGER", nullable: true),
                AttemptOutcome = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                BedClearState = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                BedClearCommandId = table.Column<Guid>(type: "TEXT", nullable: true),
                BedClearExpiresAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                FailureCode = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                FailureRetryable = table.Column<bool>(type: "INTEGER", nullable: true),
                FailureRequiresReconciliation = table.Column<bool>(type: "INTEGER", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                Id = table.Column<Guid>(type: "TEXT", nullable: false),
                Name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                Category = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false, defaultValue: "manual"),
                IsAutoGenerated = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DefaultBedTypeId = table.Column<Guid>(type: "TEXT", nullable: true),
                IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                NameLowered = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false)
            },
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                EnableTelegramNotifications = table.Column<bool>(type: "INTEGER", nullable: false),
                ...
                InAppOnJobStarted = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                InAppOnJobCompleted = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                InAppOnJobFailed = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                InAppOnJobPaused = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                EmailOnJobStarted = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                EmailOnJobCompleted = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                EmailOnJobFailed = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                EmailOnJobPaused = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                PushOnJobStarted = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                PushOnJobCompleted = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                PushOnJobFailed = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                PushOnJobPaused = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                TelegramOnJobStarted = table.Column<bool>(type: "INTEGER", nullable: false),
                TelegramOnJobCompleted = table.Column<bool>(type: "INTEGER", nullable: false),
                TelegramOnJobFailed = table.Column<bool>(type: "INTEGER", nullable: false),
                TelegramOnJobPaused = table.Column<bool>(type: "INTEGER", nullable: false),
                InAppOnPrinterFailure = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                EmailOnPrinterFailure = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                PushOnPrinterFailure = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                TelegramOnPrinterFailure = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                InAppOnFilamentRunout = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                EmailOnFilamentRunout = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                PushOnFilamentRunout = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                TelegramOnFilamentRunout = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                InAppOnHarvestReady = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                EmailOnHarvestReady = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                PushOnHarvestReady = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                TelegramOnHarvestReady = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                InAppOnMaintenanceDue = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                EmailOnMaintenanceDue = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                PushOnMaintenanceDue = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                TelegramOnMaintenanceDue = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                InAppOnPrinterOffline = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                EmailOnPrinterOffline = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                PushOnPrinterOffline = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                TelegramOnPrinterOffline = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                LastMutationSequence = table.Column<long>(type: "INTEGER", nullable: false),
                AnchorKind = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                AnchorAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ConfigurationRevision = table.Column<long>(type: "INTEGER", nullable: false, defaultValue: 1L),
                CalibrationConfigurationUpdatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                ...
                FirmwareDetectionVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                FirmwareDetectionConfidence = table.Column<decimal>(type: "TEXT", precision: 5, scale: 4, nullable: true),
                FirmwareDetectedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                FirmwareIdentityVerified = table.Column<bool>(type: "INTEGER", nullable: false),
                ...
                BedTypeId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                HasMmu = table.Column<bool>(type: "INTEGER", nullable: true),
                ...
                SupportsPerToolAttribution = table.Column<bool>(type: "INTEGER", nullable: false),
                MaxPrintSpeed = table.Column<int>(type: "INTEGER", nullable: true),
                BedOriginX = table.Column<double>(type: "REAL", nullable: true),
                BedOriginY = table.Column<double>(type: "REAL", nullable: true),
                ...
                CalibrationHasHeatedBed = table.Column<bool>(type: "INTEGER", nullable: true),
                CalibrationHasEnclosure = table.Column<bool>(type: "INTEGER", nullable: true),
                HasHeatedChamber = table.Column<bool>(type: "INTEGER", nullable: true),
                ...
                SupportsPressureAdvance = table.Column<bool>(type: "INTEGER", nullable: true),
                SupportsFirmwareRetraction = table.Column<bool>(type: "INTEGER", nullable: true),
                CalibrationHardwareVerifiedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                CalibrationSlicerEngine = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                CalibrationSlicerDistribution = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                CalibrationSlicerVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                CalibrationProfileFormat = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                CalibrationMachineProfileId = table.Column<Guid>(type: "TEXT", nullable: true),
                CalibrationProcessProfileId = table.Column<Guid>(type: "TEXT", nullable: true),
                CalibrationFilamentProfileId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                ZOffsetMm = table.Column<decimal>(type: "TEXT", nullable: true),
                LastZOffsetCalibrationAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                InMaintenance = table.Column<bool>(type: "INTEGER", nullable: false),
                IsEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                AutoDispatchEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                UseModelDispatchDefaults = table.Column<bool>(type: "INTEGER", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                SourceArtifactId = table.Column<Guid>(type: "TEXT", nullable: true),
                SourceSliceJobId = table.Column<Guid>(type: "TEXT", nullable: true),
                SourceWorkerId = table.Column<Guid>(type: "TEXT", nullable: true),
                CalibrationProjectId = table.Column<Guid>(type: "TEXT", nullable: true),
                CalibrationAttemptId = table.Column<Guid>(type: "TEXT", nullable: true),
                CalibrationOrchestrationId = table.Column<Guid>(type: "TEXT", nullable: true),
                PromotionOperationId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                PromotionOperationKey = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                PromotionCorrelationId = table.Column<Guid>(type: "TEXT", nullable: true),
                ContentSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                SpecificationSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                SourceModelSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                ...
                SlicerEngineName = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                SlicerDistribution = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                PinnedSlicerVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                SlicerContainerDigest = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                FirmwareFamily = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                GcodeDialect = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                GeneratorName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                GeneratorVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                CalibrationManifestJson = table.Column<string>(type: "TEXT", nullable: true),
                CalibrationManifestSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                IsImmutable = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Revision = table.Column<long>(type: "INTEGER", nullable: false),
                QueueRevision = table.Column<long>(type: "INTEGER", nullable: false),
                AcknowledgedJobId = table.Column<Guid>(type: "TEXT", nullable: true),
                AcknowledgedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                AcknowledgedBySubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                AcknowledgementIdempotencyKey = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                AcknowledgementExpiresAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                AcknowledgedJobRowVersion = table.Column<byte[]>(type: "BLOB", nullable: true),
                AcknowledgedQueueRevision = table.Column<long>(type: "INTEGER", nullable: true),
                AcknowledgedPrinterConfigRevision = table.Column<long>(type: "INTEGER", nullable: true),
                ActiveJobId = table.Column<Guid>(type: "TEXT", nullable: true),
                ActiveDispatchAttemptId = table.Column<Guid>(type: "TEXT", nullable: true),
                PhysicalControlCommandId = table.Column<Guid>(type: "TEXT", nullable: true),
                PhysicalControlAttemptId = table.Column<Guid>(type: "TEXT", nullable: true),
                PhysicalControlOperation = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                PhysicalControlActorSubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                PhysicalControlStartedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                PhysicalControlRequiresReconciliation = table.Column<bool>(type: "INTEGER", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ExternalPrintHours = table.Column<double>(type: "REAL", nullable: false),
                ExternalJobsCompleted = table.Column<long>(type: "INTEGER", nullable: false),
                ExternalBaselineInitializedUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                LastExternalHoursAttributionUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                LotNumber = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                OffsetZ = table.Column<double>(type: "REAL", nullable: true),
                NozzleDiameter = table.Column<double>(type: "REAL", nullable: true),
                NozzleType = table.Column<int>(type: "INTEGER", nullable: true),
                NozzleMaterial = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                NozzleMaxTemperature = table.Column<int>(type: "INTEGER", nullable: true),
                NozzleIsHardened = table.Column<bool>(type: "INTEGER", nullable: true),
                HotendMaxTemperature = table.Column<int>(type: "INTEGER", nullable: true),
                MaxVolumetricFlow = table.Column<double>(type: "REAL", nullable: true),
                DriveType = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                IsDirectDrive = table.Column<bool>(type: "INTEGER", nullable: true),
                ExtruderGearRatio = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                CurrentSpoolId = table.Column<int>(type: "INTEGER", nullable: true),
                CurrentMaterial = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                CumulativePrintHours = table.Column<double>(type: "REAL", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                KwhUsed = table.Column<decimal>(type: "TEXT", nullable: true),
                ...
                PlateName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                ...
                HarvestedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                HarvestOperationKey = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                HarvestedByUserId = table.Column<string>(type: "TEXT", maxLength: 450, nullable: true),
                HarvestedIntoBinId = table.Column<Guid>(type: "TEXT", nullable: true),
                JobKind = table.Column<int>(type: "INTEGER", nullable: true),
                CalibrationProjectId = table.Column<Guid>(type: "TEXT", nullable: true),
                CalibrationAttemptId = table.Column<Guid>(type: "TEXT", nullable: true),
                CalibrationConfigSnapshotId = table.Column<Guid>(type: "TEXT", nullable: true),
                CalibrationOrchestrationId = table.Column<Guid>(type: "TEXT", nullable: true),
                SourceArtifactId = table.Column<Guid>(type: "TEXT", nullable: true),
                SliceJobId = table.Column<Guid>(type: "TEXT", nullable: true),
                GcodeContentSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                PinnedGcodeFileSizeBytes = table.Column<long>(type: "INTEGER", nullable: true),
                CreatorSubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                IdempotencyScope = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                IdempotencyKey = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                IdempotencyRequestSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                ...
                RequiredSlicerEngine = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                RequiredSlicerDistribution = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                RequiredSlicerVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                RequiredSlicerContainerDigest = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                SpecificationSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                MachineProfileSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                ProcessProfileSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                FilamentProfileSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                PrinterConfigSnapshotSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                PinnedPrinterConfigRevision = table.Column<long>(type: "INTEGER", nullable: true),
                PinnedPrinterModelId = table.Column<Guid>(type: "TEXT", nullable: true),
                PinnedToolheadId = table.Column<Guid>(type: "TEXT", nullable: true),
                PinnedToolheadIndex = table.Column<int>(type: "INTEGER", nullable: true),
                PinnedSpoolId = table.Column<Guid>(type: "TEXT", nullable: true),
                PinnedFilamentSku = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                PinnedFilamentLotNumber = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                ActiveExternalPrinterId = table.Column<Guid>(type: "TEXT", nullable: true),
                FilamentSnapshotSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                SourceModelSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                CalibrationManifestSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                PinnedObjectDimensionX = table.Column<double>(type: "REAL", nullable: true),
                PinnedObjectDimensionY = table.Column<double>(type: "REAL", nullable: true),
                PinnedObjectDimensionZ = table.Column<double>(type: "REAL", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                PrinterId = table.Column<Guid>(type: "TEXT", nullable: false),
                CurrentPrinterConfigurationSnapshotId = table.Column<Guid>(type: "TEXT", nullable: true),
                SelectedToolheadId = table.Column<Guid>(type: "TEXT", nullable: true),
                SelectedToolheadIndex = table.Column<int>(type: "INTEGER", nullable: true),
                FilamentProvider = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                FilamentProductId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                FilamentSku = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                FilamentVendor = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                FilamentProductName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                FilamentMaterial = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                FilamentDiameter = table.Column<decimal>(type: "TEXT", precision: 6, scale: 3, nullable: true),
                FilamentColor = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                FilamentTypeId = table.Column<Guid>(type: "TEXT", nullable: true),
                SpoolmanFilamentId = table.Column<Guid>(type: "TEXT", nullable: true),
                LocalSpoolId = table.Column<Guid>(type: "TEXT", nullable: true),
                SpoolmanSpoolId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                CurrentStep = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                CurrentSelectionsJson = table.Column<string>(type: "TEXT", nullable: false),
                Revision = table.Column<long>(type: "INTEGER", nullable: false),
                CreateRequestId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                CreatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                UpdatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                CompletedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                ...
                DeletedBySubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                PrinterId = table.Column<Guid>(type: "TEXT", nullable: false),
                IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                ToolheadId = table.Column<Guid>(type: "TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                Id = table.Column<Guid>(type: "TEXT", nullable: false),
                PrintJobId = table.Column<Guid>(type: "TEXT", nullable: false),
                RootPrintJobId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                InitiatingActorSubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                RequiresOperatorReauthorization = table.Column<bool>(type: "INTEGER", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ToolheadIndex = table.Column<int>(type: "INTEGER", nullable: false),
                SpoolmanSpoolId = table.Column<int>(type: "INTEGER", nullable: true),
                SpoolSourceKind = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                SpoolSourceIdentity = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                FilamentUsageGrams = table.Column<double>(type: "REAL", nullable: true),
                IsFilamentUsageAuthoritative = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AttemptNumber = table.Column<int>(type: "INTEGER", nullable: false),
                ActorSubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                StartPathKind = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                AcknowledgementIdempotencyKey = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                ClaimedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                BackendAcceptedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                ...
                BackendJobId = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                BackendFileIdentity = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                BackendCommandId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                BackendFileName = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                BackendCallPhase = table.Column<int>(type: "INTEGER", nullable: false),
                BackendCorrelationId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                BackendCallStartedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                BackendResponseAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                ReconciliationCount = table.Column<int>(type: "INTEGER", nullable: false),
                LastReconciledAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                TerminalAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                JobRowVersionAtClaim = table.Column<byte[]>(type: "BLOB", nullable: true),
                DispatchStateRowVersionAtClaim = table.Column<byte[]>(type: "BLOB", nullable: true),
                UpdatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                EntityType = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                EntityId = table.Column<Guid>(type: "TEXT", nullable: false),
                EntityRevision = table.Column<long>(type: "INTEGER", nullable: false),
                ChangeType = table.Column<int>(type: "INTEGER", nullable: false),
                TombstoneJson = table.Column<string>(type: "TEXT", nullable: true),
                MutationId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                ActorSubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                OccurredAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false)
            },
            constraints: table =>
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DeviceLineageId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                CanonicalRequestSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                ResourceType = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                ResourceId = table.Column<Guid>(type: "TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                OccurrencePrintJobId = table.Column<Guid>(type: "TEXT", nullable: true),
                DispatchAttemptId = table.Column<Guid>(type: "TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ProjectId = table.Column<Guid>(type: "TEXT", nullable: false),
                Sequence = table.Column<long>(type: "INTEGER", nullable: false),
                ParentAttemptId = table.Column<Guid>(type: "TEXT", nullable: true),
                CalibrationKind = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                Method = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                DefinitionVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                InputJson = table.Column<string>(type: "TEXT", nullable: false),
                SpecificationJson = table.Column<string>(type: "TEXT", nullable: false),
                SpecificationSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                PrinterConfigurationSnapshotId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                AttemptRequestId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                CreatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                CreatedBySubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false)
            },
            constraints: table =>
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ToolheadHoursAtMaintenance = table.Column<double>(type: "REAL", nullable: true),
                CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DerivedStatus = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                Model3DId = table.Column<Guid>(type: "TEXT", nullable: true),
                SliceJobId = table.Column<Guid>(type: "TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AttemptId = table.Column<Guid>(type: "TEXT", nullable: false),
                Sequence = table.Column<long>(type: "INTEGER", nullable: false),
                ObservationType = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                ...
                RetestRecommended = table.Column<bool>(type: "INTEGER", nullable: false),
                Notes = table.Column<string>(type: "TEXT", nullable: true),
                SelectionParentObservationId = table.Column<Guid>(type: "TEXT", nullable: true),
                SelectionReason = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                OperationId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                UpdatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                CompletedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                GenerationRequestSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                SpecificationSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                PlanManifestSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                GcodeSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                ManifestSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                GeneratorVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                SlicerContainerDigest = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                SlicerBinarySha256 = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                WorkerId = table.Column<Guid>(type: "TEXT", nullable: true),
                FinalArtifactId = table.Column<Guid>(type: "TEXT", nullable: true),
                PromotionOperationId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                StepStartedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ProjectId = table.Column<Guid>(type: "TEXT", nullable: false),
                AttemptId = table.Column<Guid>(type: "TEXT", nullable: false),
                ClientUploadId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                OpaqueStorageKey = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                ...
                Caption = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                Revision = table.Column<long>(type: "INTEGER", nullable: false),
                CreatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                CreatedBySubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                DeletedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                DeletedBySubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                DeleteRequestedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
