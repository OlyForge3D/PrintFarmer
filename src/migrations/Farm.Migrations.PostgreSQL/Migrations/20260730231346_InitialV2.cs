    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Scopes = table.Column<int>(type: "integer", nullable: false, defaultValue: 0)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                PartInventoryId = table.Column<Guid>(type: "uuid", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                JobRowVersion = table.Column<byte[]>(type: "bytea", nullable: false),
                DispatchStateRowVersion = table.Column<byte[]>(type: "bytea", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            {
                Id = table.Column<Guid>(type: "uuid", nullable: false),
                OpaqueStorageKey = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                LoadBalancingStrategy = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                CreatedDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                UpdatedDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
            },
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DefaultPricePerKg = table.Column<double>(type: "double precision", nullable: true),
                DefaultDensity = table.Column<double>(type: "double precision", nullable: true),
                CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                IsActive = table.Column<bool>(type: "boolean", nullable: false)
            },
            constraints: table =>
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                SourceSliceJobId = table.Column<Guid>(type: "uuid", nullable: false),
                SourceWorkerId = table.Column<Guid>(type: "uuid", nullable: true),
                SourceContentSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                SourceSizeBytes = table.Column<long>(type: "bigint", nullable: false),
                CalibrationProjectId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationAttemptId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationOrchestrationId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                SourceAcknowledgedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Path = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false, defaultValue: "/"),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AggregateRowVersion = table.Column<byte[]>(type: "bytea", nullable: true),
                JobRevision = table.Column<long>(type: "bigint", nullable: true),
                PrinterId = table.Column<Guid>(type: "uuid", nullable: true),
                ProjectId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationAttemptId = table.Column<Guid>(type: "uuid", nullable: true),
                JobStatus = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                JobKind = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                ...
                AttemptOutcome = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                BedClearState = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                BedClearCommandId = table.Column<Guid>(type: "uuid", nullable: true),
                BedClearExpiresAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                FailureCode = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                FailureRetryable = table.Column<bool>(type: "boolean", nullable: true),
                FailureRequiresReconciliation = table.Column<bool>(type: "boolean", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                Id = table.Column<Guid>(type: "uuid", nullable: false),
                Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                Category = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false, defaultValue: "manual"),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DefaultWattage = table.Column<decimal>(type: "numeric", nullable: true),
                DefaultHourlyRate = table.Column<decimal>(type: "numeric", nullable: true),
                DefaultAutoDispatchState = table.Column<int>(type: "integer", nullable: false),
                DefaultStartBehavior = table.Column<int>(type: "integer", nullable: true),
                DefaultBedTypeId = table.Column<Guid>(type: "uuid", nullable: true),
                IsActive = table.Column<bool>(type: "boolean", nullable: false),
                UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                NameLowered = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false)
            },
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AppBundleId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                EnableTelegramNotifications = table.Column<bool>(type: "boolean", nullable: false),
                ...
                InAppOnJobStarted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                InAppOnJobCompleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                InAppOnJobFailed = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                InAppOnJobPaused = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                EmailOnJobStarted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                EmailOnJobCompleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                EmailOnJobFailed = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                EmailOnJobPaused = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                PushOnJobStarted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                PushOnJobCompleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                PushOnJobFailed = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                PushOnJobPaused = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                TelegramOnJobStarted = table.Column<bool>(type: "boolean", nullable: false),
                TelegramOnJobCompleted = table.Column<bool>(type: "boolean", nullable: false),
                TelegramOnJobFailed = table.Column<bool>(type: "boolean", nullable: false),
                TelegramOnJobPaused = table.Column<bool>(type: "boolean", nullable: false),
                InAppOnPrinterFailure = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                EmailOnPrinterFailure = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                PushOnPrinterFailure = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                TelegramOnPrinterFailure = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                InAppOnFilamentRunout = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                EmailOnFilamentRunout = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                PushOnFilamentRunout = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                TelegramOnFilamentRunout = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                InAppOnHarvestReady = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                EmailOnHarvestReady = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                PushOnHarvestReady = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                TelegramOnHarvestReady = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                InAppOnMaintenanceDue = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                EmailOnMaintenanceDue = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                PushOnMaintenanceDue = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                TelegramOnMaintenanceDue = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                InAppOnPrinterOffline = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                EmailOnPrinterOffline = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                PushOnPrinterOffline = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                TelegramOnPrinterOffline = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                AttentionPushCategoryPreferencesJson = table.Column<string>(type: "text", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                PrintablesUsername = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                PrintablesOAuthAccessToken = table.Column<string>(type: "character varying(4096)", maxLength: 4096, nullable: true),
                PrintablesOAuthRefreshToken = table.Column<string>(type: "character varying(4096)", maxLength: 4096, nullable: true),
                PrintablesOAuthTokenType = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                PrintablesOAuthScope = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                PrintablesOAuthTokenExpiresAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                PrintablesOAuthLinkedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                RowVersion = table.Column<byte[]>(type: "bytea", nullable: false)
            },
            constraints: table =>
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AnchorKind = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                AnchorAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                WindowStartUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                WindowEndUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                CalibrationConfigurationUpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                FirmwareFamily = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                GcodeDialect = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                FirmwareDetectionSource = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                FirmwareVersion = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                FirmwareDetectionVersion = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                FirmwareDetectionConfidence = table.Column<decimal>(type: "numeric(5,4)", precision: 5, scale: 4, nullable: true),
                FirmwareDetectedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                FirmwareIdentityVerified = table.Column<bool>(type: "boolean", nullable: false),
                ...
                BuddyCameraIp = table.Column<string>(type: "text", nullable: true),
                ManufacturerId = table.Column<Guid>(type: "uuid", nullable: false),
                ModelId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                BedTypeId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                NozzleDiameter = table.Column<double>(type: "double precision", nullable: true),
                HasMmu = table.Column<bool>(type: "boolean", nullable: true),
                ...
                SupportsPerToolAttribution = table.Column<bool>(type: "boolean", nullable: false),
                MaxPrintSpeed = table.Column<int>(type: "integer", nullable: true),
                BedOriginX = table.Column<double>(type: "double precision", nullable: true),
                BedOriginY = table.Column<double>(type: "double precision", nullable: true),
                PrintablePolygonJson = table.Column<string>(type: "text", nullable: true),
                ExcludedRegionsJson = table.Column<string>(type: "text", nullable: true),
                CalibrationMotionType = table.Column<int>(type: "integer", nullable: true),
                MaxTravelSpeed = table.Column<int>(type: "integer", nullable: true),
                MaxAcceleration = table.Column<int>(type: "integer", nullable: true),
                MaxTravelAcceleration = table.Column<int>(type: "integer", nullable: true),
                CalibrationHasHeatedBed = table.Column<bool>(type: "boolean", nullable: true),
                CalibrationHasEnclosure = table.Column<bool>(type: "boolean", nullable: true),
                HasHeatedChamber = table.Column<bool>(type: "boolean", nullable: true),
                MaxChamberTemp = table.Column<int>(type: "integer", nullable: true),
                ActiveToolheadIndex = table.Column<int>(type: "integer", nullable: true),
                SupportsPressureAdvance = table.Column<bool>(type: "boolean", nullable: true),
                SupportsFirmwareRetraction = table.Column<bool>(type: "boolean", nullable: true),
                CalibrationHardwareVerifiedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                CalibrationSlicerEngine = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                CalibrationSlicerDistribution = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                CalibrationSlicerVersion = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                CalibrationProfileFormat = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                CalibrationMachineProfileId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationProcessProfileId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationFilamentProfileId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                Wattage = table.Column<decimal>(type: "numeric", nullable: true),
                MachineHourlyRate = table.Column<decimal>(type: "numeric", nullable: true),
                ObicoEnabled = table.Column<bool>(type: "boolean", nullable: false),
                ZOffsetMm = table.Column<decimal>(type: "numeric", nullable: true),
                LastZOffsetCalibrationAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                InMaintenance = table.Column<bool>(type: "boolean", nullable: false),
                IsEnabled = table.Column<bool>(type: "boolean", nullable: false),
                AutoDispatchEnabled = table.Column<bool>(type: "boolean", nullable: false),
                UseModelDispatchDefaults = table.Column<bool>(type: "boolean", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                HealthMessage = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                JobName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                FileName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                Confidence = table.Column<decimal>(type: "numeric(5,4)", nullable: false),
                DetectedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                SnapshotUrl = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
                AutoPaused = table.Column<bool>(type: "boolean", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                FirstLayerHeight = table.Column<double>(type: "double precision", nullable: true),
                SupportEnabled = table.Column<bool>(type: "boolean", nullable: true),
                ToolChangesCount = table.Column<int>(type: "integer", nullable: true),
                ObjectDimensionX = table.Column<double>(type: "double precision", nullable: true),
                ObjectDimensionY = table.Column<double>(type: "double precision", nullable: true),
                ObjectDimensionZ = table.Column<double>(type: "double precision", nullable: true),
                ObjectCount = table.Column<int>(type: "integer", nullable: true),
                RetractionLength = table.Column<double>(type: "double precision", nullable: true),
                RetractionSpeed = table.Column<double>(type: "double precision", nullable: true),
                TopSolidLayers = table.Column<int>(type: "integer", nullable: true),
                BottomSolidLayers = table.Column<int>(type: "integer", nullable: true),
                MaxVolumetricSpeed = table.Column<double>(type: "double precision", nullable: true),
                IroningEnabled = table.Column<bool>(type: "boolean", nullable: true),
                PrinterGroupId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                FilamentPerExtruderColorHex = table.Column<string>(type: "text", nullable: true),
                FilamentPerExtruderType = table.Column<string>(type: "text", nullable: true),
                ExtruderCount = table.Column<int>(type: "integer", nullable: true),
                SourceArtifactId = table.Column<Guid>(type: "uuid", nullable: true),
                SourceSliceJobId = table.Column<Guid>(type: "uuid", nullable: true),
                SourceWorkerId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationProjectId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationAttemptId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationOrchestrationId = table.Column<Guid>(type: "uuid", nullable: true),
                PromotionOperationId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                PromotionOperationKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                PromotionCorrelationId = table.Column<Guid>(type: "uuid", nullable: true),
                ContentSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                SpecificationSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                SourceModelSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ...
                SlicerEngineName = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                SlicerDistribution = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                PinnedSlicerVersion = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                SlicerContainerDigest = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                FirmwareFamily = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                GcodeDialect = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                GeneratorName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                GeneratorVersion = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                CalibrationManifestJson = table.Column<string>(type: "text", nullable: true),
                CalibrationManifestSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Revision = table.Column<long>(type: "bigint", nullable: false),
                QueueRevision = table.Column<long>(type: "bigint", nullable: false),
                AcknowledgedJobId = table.Column<Guid>(type: "uuid", nullable: true),
                AcknowledgedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                AcknowledgedBySubject = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                AcknowledgementIdempotencyKey = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                AcknowledgementExpiresAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                AcknowledgedJobRowVersion = table.Column<byte[]>(type: "bytea", nullable: true),
                ...
                ActiveDispatchAttemptId = table.Column<Guid>(type: "uuid", nullable: true),
                PhysicalControlCommandId = table.Column<Guid>(type: "uuid", nullable: true),
                PhysicalControlAttemptId = table.Column<Guid>(type: "uuid", nullable: true),
                PhysicalControlOperation = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                PhysicalControlActorSubject = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                PhysicalControlStartedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                PhysicalControlRequiresReconciliation = table.Column<bool>(type: "boolean", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ExternalPrintHours = table.Column<double>(type: "double precision", nullable: false),
                ExternalJobsCompleted = table.Column<long>(type: "bigint", nullable: false),
                ExternalBaselineInitializedUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                LastExternalHoursAttributionUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                LotNumber = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                NozzleDiameter = table.Column<double>(type: "double precision", nullable: true),
                NozzleType = table.Column<int>(type: "integer", nullable: true),
                NozzleMaterial = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                NozzleMaxTemperature = table.Column<int>(type: "integer", nullable: true),
                NozzleIsHardened = table.Column<bool>(type: "boolean", nullable: true),
                HotendMaxTemperature = table.Column<int>(type: "integer", nullable: true),
                MaxVolumetricFlow = table.Column<double>(type: "double precision", nullable: true),
                DriveType = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                IsDirectDrive = table.Column<bool>(type: "boolean", nullable: true),
                ExtruderGearRatio = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                CurrentSpoolId = table.Column<int>(type: "integer", nullable: true),
                CurrentMaterial = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                CumulativePrintHours = table.Column<double>(type: "double precision", nullable: false),
                CurrentFilamentColor = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                RequiredMaterialsPerToolJson = table.Column<string>(type: "text", nullable: true),
                ...
                KwhUsed = table.Column<decimal>(type: "numeric", nullable: true),
                EnergyCostUsd = table.Column<decimal>(type: "numeric", nullable: true),
                MachineTimeCostUsd = table.Column<decimal>(type: "numeric", nullable: true),
                LaborCostUsd = table.Column<decimal>(type: "numeric", nullable: true),
                TotalCostUsd = table.Column<decimal>(type: "numeric", nullable: true),
                CostCalculatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                IsExternalPrint = table.Column<bool>(type: "boolean", nullable: false),
                ...
                PlateIndex = table.Column<int>(type: "integer", nullable: true),
                PlateName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                DispatchedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                DispatchScore = table.Column<double>(type: "double precision", nullable: true),
                ...
                HarvestOperationKey = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                HarvestedByUserId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                HarvestedIntoBinId = table.Column<Guid>(type: "uuid", nullable: true),
                JobKind = table.Column<int>(type: "integer", nullable: true),
                CalibrationProjectId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationAttemptId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationConfigSnapshotId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationOrchestrationId = table.Column<Guid>(type: "uuid", nullable: true),
                SourceArtifactId = table.Column<Guid>(type: "uuid", nullable: true),
                SliceJobId = table.Column<Guid>(type: "uuid", nullable: true),
                GcodeContentSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                PinnedGcodeFileSizeBytes = table.Column<long>(type: "bigint", nullable: true),
                CreatorSubject = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                IdempotencyScope = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                IdempotencyKey = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                IdempotencyRequestSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                RequiredFirmwareFamily = table.Column<int>(type: "integer", nullable: true),
                RequiredGcodeDialect = table.Column<int>(type: "integer", nullable: true),
                RequiredSlicerEngine = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                RequiredSlicerDistribution = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                RequiredSlicerVersion = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                RequiredSlicerContainerDigest = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                SpecificationSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                MachineProfileSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ProcessProfileSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                FilamentProfileSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                PrinterConfigSnapshotSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                PinnedPrinterConfigRevision = table.Column<long>(type: "bigint", nullable: true),
                PinnedPrinterModelId = table.Column<Guid>(type: "uuid", nullable: true),
                PinnedToolheadId = table.Column<Guid>(type: "uuid", nullable: true),
                PinnedToolheadIndex = table.Column<int>(type: "integer", nullable: true),
                PinnedSpoolId = table.Column<Guid>(type: "uuid", nullable: true),
                PinnedFilamentSku = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                PinnedFilamentLotNumber = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                ActiveExternalPrinterId = table.Column<Guid>(type: "uuid", nullable: true),
                FilamentSnapshotSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                SourceModelSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                CalibrationManifestSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                PinnedObjectDimensionX = table.Column<double>(type: "double precision", nullable: true),
                PinnedObjectDimensionY = table.Column<double>(type: "double precision", nullable: true),
                PinnedObjectDimensionZ = table.Column<double>(type: "double precision", nullable: true),
                BlockedReasonCode = table.Column<int>(type: "integer", nullable: true),
                BlockedReasonJson = table.Column<string>(type: "text", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ExperienceMode = table.Column<int>(type: "integer", nullable: false),
                PrinterId = table.Column<Guid>(type: "uuid", nullable: false),
                CurrentPrinterConfigurationSnapshotId = table.Column<Guid>(type: "uuid", nullable: true),
                SelectedToolheadId = table.Column<Guid>(type: "uuid", nullable: true),
                SelectedToolheadIndex = table.Column<int>(type: "integer", nullable: true),
                FilamentProvider = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                FilamentProductId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                FilamentSku = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                FilamentVendor = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                FilamentProductName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                FilamentMaterial = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                FilamentDiameter = table.Column<decimal>(type: "numeric(6,3)", precision: 6, scale: 3, nullable: true),
                FilamentColor = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                FilamentTypeId = table.Column<Guid>(type: "uuid", nullable: true),
                SpoolmanFilamentId = table.Column<Guid>(type: "uuid", nullable: true),
                LocalSpoolId = table.Column<Guid>(type: "uuid", nullable: true),
                SpoolmanSpoolId = table.Column<Guid>(type: "uuid", nullable: true),
                FilamentSnapshotJson = table.Column<string>(type: "text", nullable: false),
                OrderedStepsJson = table.Column<string>(type: "text", nullable: false),
                CurrentStep = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                CurrentSelectionsJson = table.Column<string>(type: "text", nullable: false),
                Revision = table.Column<long>(type: "bigint", nullable: false),
                CreateRequestId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                CompletedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                DeletedBySubject = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            {
                Id = table.Column<Guid>(type: "uuid", nullable: false),
                FallbackGroupId = table.Column<Guid>(type: "uuid", nullable: false),
                ToolheadId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_FilamentFallbackGroupMembers_FilamentFallbackGroups_Fallbac~",
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                PrinterId = table.Column<Guid>(type: "uuid", nullable: false),
                IsActive = table.Column<bool>(type: "boolean", nullable: false),
                ToolheadId = table.Column<Guid>(type: "uuid", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DispatchMode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                Score = table.Column<double>(type: "double precision", nullable: true),
                ScoreBreakdown = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: true),
                ScoringDetails = table.Column<string>(type: "character varying(8000)", maxLength: 8000, nullable: true),
                Reason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                DispatchedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                DispatchedByUserId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                Id = table.Column<Guid>(type: "uuid", nullable: false),
                PrintJobId = table.Column<Guid>(type: "uuid", nullable: false),
                RootPrintJobId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                InitiatingActorSubject = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                RequiresOperatorReauthorization = table.Column<bool>(type: "boolean", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ToolheadIndex = table.Column<int>(type: "integer", nullable: false),
                SpoolmanSpoolId = table.Column<int>(type: "integer", nullable: true),
                SpoolSourceKind = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                SpoolSourceIdentity = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                FilamentUsageGrams = table.Column<double>(type: "double precision", nullable: true),
                IsFilamentUsageAuthoritative = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                SlicerEstimateGrams = table.Column<double>(type: "double precision", nullable: true),
                FilamentName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                FilamentColor = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                MaterialCostUsd = table.Column<decimal>(type: "numeric", nullable: true)
            },
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AttemptNumber = table.Column<int>(type: "integer", nullable: false),
                ActorSubject = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                StartPathKind = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                AcknowledgementIdempotencyKey = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                ClaimedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                BackendAcceptedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                IsRetryable = table.Column<bool>(type: "boolean", nullable: false),
                RequiresReconciliation = table.Column<bool>(type: "boolean", nullable: false),
                BackendJobId = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                BackendFileIdentity = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                BackendCommandId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                BackendFileName = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                BackendCallPhase = table.Column<int>(type: "integer", nullable: false),
                BackendCorrelationId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                BackendCallStartedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                BackendResponseAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                JobRowVersionAtClaim = table.Column<byte[]>(type: "bytea", nullable: true),
                DispatchStateRowVersionAtClaim = table.Column<byte[]>(type: "bytea", nullable: true),
                UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                TombstoneJson = table.Column<string>(type: "text", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DeviceLineageId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                CanonicalRequestSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ResourceType = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ResourceId = table.Column<Guid>(type: "uuid", nullable: true),
                StoredStatusCode = table.Column<int>(type: "integer", nullable: false),
                StoredResultJson = table.Column<string>(type: "text", nullable: true),
                State = table.Column<int>(type: "integer", nullable: false),
                CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                CompletedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                OccurrencePrintJobId = table.Column<Guid>(type: "uuid", nullable: true),
                DispatchAttemptId = table.Column<Guid>(type: "uuid", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                Sequence = table.Column<long>(type: "bigint", nullable: false),
                ParentAttemptId = table.Column<Guid>(type: "uuid", nullable: true),
                CalibrationKind = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                Method = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                SpecificationSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                PrinterConfigurationSnapshotId = table.Column<Guid>(type: "uuid", nullable: false),
                ProfileSnapshotIdsJson = table.Column<string>(type: "text", nullable: false),
                ActualSpoolSnapshotJson = table.Column<string>(type: "text", nullable: true),
                AttemptRequestId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                CreatedBySubject = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false)
            },
            constraints: table =>
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ToolheadHoursAtMaintenance = table.Column<double>(type: "double precision", nullable: true),
                CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DerivedStatus = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ...
                RetryNumber = table.Column<int>(type: "integer", nullable: true),
                OperationId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                OccurredAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ActorSubject = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false)
            },
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AttemptId = table.Column<Guid>(type: "uuid", nullable: false),
                Sequence = table.Column<long>(type: "bigint", nullable: false),
                ObservationType = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                RetestRecommended = table.Column<bool>(type: "boolean", nullable: false),
                Notes = table.Column<string>(type: "text", nullable: true),
                SelectionParentObservationId = table.Column<Guid>(type: "uuid", nullable: true),
                SelectionReason = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                OperationId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                LastErrorJson = table.Column<string>(type: "text", nullable: true),
                Model3DId = table.Column<Guid>(type: "uuid", nullable: true),
                SliceJobId = table.Column<Guid>(type: "uuid", nullable: true),
                SourceArtifactId = table.Column<Guid>(type: "uuid", nullable: true),
                GcodeFileId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                CompletedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                GenerationRequestSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                SpecificationSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                PlanManifestSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                GcodeSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ManifestSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                GeneratorVersion = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                SlicerContainerDigest = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                SlicerBinarySha256 = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                WorkerId = table.Column<Guid>(type: "uuid", nullable: true),
                FinalArtifactId = table.Column<Guid>(type: "uuid", nullable: true),
                PromotionOperationId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                StepStartedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                AttemptId = table.Column<Guid>(type: "uuid", nullable: false),
                ClientUploadId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                OpaqueStorageKey = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
        ...
        migrationBuilder.InsertData(
            ...
            columns: new[] { "Id", "AutoDispatchEnabled", "AutoDispatchMode", "CreatedDate", "IdleThresholdSeconds", "LoadBalancingStrategy", "MaxConcurrentDispatches", "MinimumScoreThreshold", "Revision", "RowVersion", "UpdatedAt", "UpdatedDate" },
            values: new object[] { 1, false, "Manual", new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 30, "BestFit", 3, 0.5, 1L, null, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
        ...
        migrationBuilder.CreateIndex(
            name: "IX_GcodePromotionCheckpoints_SourceArtifactId_SourceContentSha~",
            table: "GcodePromotionCheckpoints",
