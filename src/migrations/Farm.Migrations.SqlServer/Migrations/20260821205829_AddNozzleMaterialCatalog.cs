...
namespace Farm.Migrations.SqlServer.Migrations
{
    ...
    public partial class AddNozzleMaterialCatalog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHardened = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    DefaultMaxTemp = table.Column<int>(type: "int", nullable: false, defaultValue: 500),
            ...
            migrationBuilder.Sql(@"
                UPDATE nmd
                SET nmd.[NozzleMaterialId] = nm.[Id]
                FROM [NozzleModelDefinitions] nmd
                INNER JOIN [NozzleMaterials] nm ON nm.[Name] = CASE nmd.[NozzleType]
                    WHEN 0 THEN 'Brass'
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                UPDATE nmd
                SET nmd.[NozzleType] = CASE nm.[Name]
                    WHEN 'Brass' THEN 0
                ...
                END
                FROM [NozzleModelDefinitions] nmd
                INNER JOIN [NozzleMaterials] nm ON nm.[Id] = nmd.[NozzleMaterialId];
            ");
