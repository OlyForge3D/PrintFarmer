    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                PrintJobId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                HarvestDiscoveredFileId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                GcodeFileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                GcodeFileId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
            },
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    ...
                    onDelete: ReferentialAction.Restrict);
                table.ForeignKey(
                    name: "FK_HarvestFileGcodeFileMappings_HarvestDiscoveredFiles_HarvestDiscoveredFileId1",
