...
/// <inheritdoc />
public partial class SlicerInitialV2 : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DeclaredSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ...
                PromotionCheckpointId = table.Column<Guid>(type: "uuid", nullable: true),
                PromotionStartedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                PromotedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                PromotedGcodeFileId = table.Column<Guid>(type: "uuid", nullable: true),
                CleanupReservationToken = table.Column<Guid>(type: "uuid", nullable: true),
                CleanupReservedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                CleanupDeletionStartedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                SlicerDistribution = table.Column<string>(type: "text", nullable: true),
                ProfileFormat = table.Column<string>(type: "text", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ClientUploadHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ...
                SourceLicense = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                SourceCreator = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                SlicerEngineVersion = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                ...
                ModelSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ...
                LeaseFence = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                CalibrationProjectId = table.Column<Guid>(type: "uuid", nullable: true),
                IdempotencyScopeId = table.Column<Guid>(type: "uuid", nullable: false, defaultValue: Guid.Empty),
                ...
                MachineProfileJson = table.Column<string>(type: "TEXT", nullable: true),
                ProcessProfileJson = table.Column<string>(type: "TEXT", nullable: true),
                FilamentProfileJson = table.Column<string>(type: "TEXT", nullable: true),
                ...
                PinnedWorkerId = table.Column<Guid>(type: "uuid", nullable: true),
                SlicerBinarySha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                ModelTransformJson = table.Column<string>(type: "text", nullable: true),
                ExtruderFilamentProfileNamesJson = table.Column<string>(type: "TEXT", nullable: true),
                ModelFileUrlsJson = table.Column<string>(type: "TEXT", nullable: true),
                ModelFileTransformsJson = table.Column<string>(type: "text", nullable: true)
            },
            constraints: table =>
            {
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        throw new NotSupportedException(
            "The slicer schema is forward-only because valid head data can contain " +
            "repeated standard-job checksums and correlations that a revert cannot " +
            "disambiguate. Restore from backup instead of reverting this migration.");
    }
}
