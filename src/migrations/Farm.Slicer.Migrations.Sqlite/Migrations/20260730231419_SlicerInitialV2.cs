    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                DeclaredSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                ...
                PromotionCheckpointId = table.Column<Guid>(type: "TEXT", nullable: true),
                PromotionStartedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                PromotedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                PromotedGcodeFileId = table.Column<Guid>(type: "TEXT", nullable: true),
                CleanupReservationToken = table.Column<Guid>(type: "TEXT", nullable: true),
                CleanupReservedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                CleanupDeletionStartedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ClientUploadId = table.Column<Guid>(type: "TEXT", nullable: true),
                ClientUploadHash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                ...
                SourceLicense = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                SourceCreator = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                SlicerEngineVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                ...
                ModelSha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                ...
                LeaseFence = table.Column<long>(type: "INTEGER", nullable: false, defaultValue: 0L),
                CalibrationProjectId = table.Column<Guid>(type: "TEXT", nullable: true),
                IdempotencyScopeId = table.Column<Guid>(type: "TEXT", nullable: false, defaultValue: Guid.Empty),
                ...
                PinnedWorkerId = table.Column<Guid>(type: "TEXT", nullable: true),
                SlicerBinarySha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
