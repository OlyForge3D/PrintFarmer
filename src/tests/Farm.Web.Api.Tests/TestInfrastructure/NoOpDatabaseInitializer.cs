...
namespace Farm.Web.Api.Tests.TestInfrastructure
{
    ...
    public sealed class NoOpDatabaseInitializer(Farm.Infrastructure.Data.AppDbContext context, IUnifiedLoggingService logger, IDataSeedService dataSeedService) : Api.Services.DatabaseInitializer(context, logger, dataSeedService)
    {
