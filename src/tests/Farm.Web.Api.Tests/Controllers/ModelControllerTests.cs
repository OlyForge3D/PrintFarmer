...
namespace Farm.Web.Api.Tests.Controllers
{
    public class ModelControllerTests
    {
        ...
        public async Task ListModelsAsync_DelegatesToService()
        {
            ...
            var controller = new ModelController(mockLogger.Object, mockService.Object, mockConfig.Object, mockAnalysis.Object, mockVirus.Object, mockThumb.Object, TestFileSystemFactory.WithFiles(new Dictionary<string, byte[]>()), mockFileManagement.Object);
        ...
        public async Task GetModelThumbnailAsync_NoThumb_ReturnsNotFound()
        {
            ...
            var controller = new ModelController(mockLogger.Object, mockService.Object, mockConfig.Object, mockAnalysis.Object, mockVirus.Object, mockThumb.Object, TestFileSystemFactory.WithFiles(new System.Collections.Generic.Dictionary<string, byte[]>()), mockFileManagement.Object);
        ...
        public async Task GetModelFileAsync_ReturnsPhysicalFile()
        {
            ...
            var controller = new ModelController(mockLogger.Object, modelService, configReal, mockAnalysis.Object, mockVirus.Object, mockThumb.Object, testFs, mockFileManagement.Object);
        ...
        public async Task GetModelThumbnailAsync_ReturnsPhysicalFile()
        {
            ...
            var controller2 = new ModelController(mockLogger.Object, mockService.Object, configReal2, mockAnalysis.Object, mockVirus.Object, mockThumb.Object, testFs2, mockFileManagement.Object);
