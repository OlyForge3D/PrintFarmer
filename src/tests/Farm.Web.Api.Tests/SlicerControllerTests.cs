...
public class SlicerControllerTests : IClassFixture<CustomWebApplicationFactory>
{
    ...
    public async Task GetSlicingJob_ShouldReturnJobInfo_WhenJobExists()
    {
        ...
        // Act
        var response = await _client.GetAsync($"/api/slicer/job/{sliceResult.JobId}");
    ...
    public async Task GetSlicingJob_ShouldReturnNotFound_WhenJobDoesNotExist()
    {
        ...
        // Act
        var response = await _client.GetAsync($"/api/slicer/job/{nonExistentJobId}");
    ...
    public async Task CancelSlicingJob_ShouldCancelJob_WhenJobExists()
    {
        ...
        // Act
        var response = await _client.PostAsync($"/api/slicer/job/{sliceResult.JobId}/cancel", null);
    ...
    public async Task CancelSlicingJob_ShouldReturnNotFound_WhenJobDoesNotExist()
    {
        ...
        // Act
        var response = await _client.PostAsync($"/api/slicer/job/{nonExistentJobId}/cancel", null);
