...
/// </summary>
public class AuthAuditServiceIntegrationTests : IClassFixture<CustomWebApplicationFactory>, IAsyncLifetime
{
    ...
    public async Task LogLoginFailedAsync_WithValidParameters_SavesFailureLog()
    {
        ...
        logs.First(l => l.EventType == AuthEventType.LoginFailed && l.FailureReason == "Invalid password").Success.Should().BeFalse();
    }
