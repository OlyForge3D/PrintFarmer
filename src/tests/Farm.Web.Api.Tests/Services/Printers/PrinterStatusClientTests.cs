...
public class PrinterStatusClientTests
{
        ...
        ILogger<PrinterStatusClientFactory> logger)
    {
        ...
        var spoolProvider = CreateSpoolProvider();
        var moonrakerStatusClient = new MoonrakerStatusClient(moonrakerClient, circuitBreaker, spoolProvider, NullLogger<MoonrakerStatusClient>.Instance);
        var prusaLinkStatusClient = new PrusaLinkStatusClient(prusaLinkClient, circuitBreaker, spoolProvider, NullLogger<PrusaLinkStatusClient>.Instance);
        var sdcpStatusClient = new SdcpStatusClient(sdcpClient, circuitBreaker, spoolProvider, NullLogger<SdcpStatusClient>.Instance);
        var octoPrintStatusClient = new OctoPrintStatusClient(octoPrintClient, circuitBreaker, spoolProvider, NullLogger<OctoPrintStatusClient>.Instance);
        ...
        services.AddSingleton(Mock.Of<ISpoolmanService>());
        services.AddSingleton(spoolProvider);
    ...
    public void PrinterStatusClientFactory_GetStatusClient_ReturnsMoonrakerClient()
    {
        ...
        // Act
        IPrinterStatusClient client = factory.GetStatusClient(PrinterBackend.Moonraker);
    ...
    public void PrinterStatusClientFactory_GetStatusClient_ReturnsPrusaLinkClient()
    {
        ...
        // Act
        IPrinterStatusClient client = factory.GetStatusClient(PrinterBackend.PrusaLink);
    ...
    public void PrinterStatusClientFactory_GetStatusClient_ReturnsSdcpClient()
    {
        ...
        // Act
        IPrinterStatusClient client = factory.GetStatusClient(PrinterBackend.SDCP);
    ...
    public void PrinterStatusClientFactory_GetStatusClient_ReturnsOctoPrintClient()
    {
        ...
        // Act
        IPrinterStatusClient client = factory.GetStatusClient(PrinterBackend.OctoPrint);
    ...
    public void PrinterStatusClientFactory_GetStatusClient_WithIntBackendValue_ReturnsMoonrakerClient()
    {
        ...
        // Act
        IPrinterStatusClient client = factory.GetStatusClient((int)PrinterBackend.Moonraker);
