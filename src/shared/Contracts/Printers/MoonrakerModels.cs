...
namespace Farm.Web.Shared.Contracts.Printers.Moonraker;
...
// History Models - Use Farm.Web.Shared.HistoryListResponse, HistoryJob, HistoryTotals, etc.
// These types are defined in shared/Models.cs and should be used directly.
