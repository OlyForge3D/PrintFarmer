...
namespace Farm.Web.Api.Repositories.FileConsistency
{
    public class EfFileConsistencyRepository : IFileConsistencyRepository
    {
        private readonly AppDbContext _db;

        public EfFileConsistencyRepository(AppDbContext db)
        {
