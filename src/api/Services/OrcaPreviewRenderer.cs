...
public sealed class OrcaPreviewRenderer : BasePreviewRenderer
{
    ...
    {
        RenderOptions d = OrcaPreset.Create();
    ...
    protected override Rgba32 ShadeTriangle(Vector3 normal, float ao, RenderOptions options)
    {
        ...
        // Final linear color
        Vector3 baseColor = options.BaseColorLinear;
        Vector3 lit = (baseColor * lightTerm * aoTerm) + new Vector3(spec);
