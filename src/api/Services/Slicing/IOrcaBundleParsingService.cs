...
{
    /// <summary>
    /// Parses an OrcaSlicer config bundle JSON and returns a preview of all detected presets.
    /// </summary>
    ...
    /// <summary>
    /// Validates whether the provided JSON matches OrcaSlicer bundle format.
    /// </summary>
