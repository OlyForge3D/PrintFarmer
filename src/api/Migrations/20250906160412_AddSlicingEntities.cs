...
{
    /// <inheritdoc />
    public partial class AddSlicingEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VolumeM3 = table.Column<double>(type: "REAL", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "PrinterModelFilamentTypes",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrinterModelFilamentTypes", x => new { x.PrinterModelId, x.FilamentTypeId });
                    table.ForeignKey(
                        name: "FK_PrinterModelFilamentTypes_FilamentTypes_FilamentTypeId",
                        column: x => x.FilamentTypeId,
                        principalTable: "FilamentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrinterModelFilamentTypes_Models_PrinterModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SlicerProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SlicerProfiles_Models_PrinterModelId",
                        column: x => x.PrinterModelId,
                        principalTable: "Models",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SlicerProfiles_Printers_SpecificPrinterId",
                        column: x => x.SpecificPrinterId,
                        principalTable: "Printers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SlicerProfiles_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrinterModelFilamentTypes_FilamentTypeId",
                table: "PrinterModelFilamentTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SlicerProfiles_CreatedByUserId",
                table: "SlicerProfiles",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SlicerProfiles_IsDefault",
                table: "SlicerProfiles",
                column: "IsDefault");

            migrationBuilder.CreateIndex(
                name: "IX_SlicerProfiles_IsPublic",
                table: "SlicerProfiles",
                column: "IsPublic");

            migrationBuilder.CreateIndex(
                name: "IX_SlicerProfiles_Name_SlicerType_PrinterModelId",
                table: "SlicerProfiles",
                columns: new[] { "Name", "SlicerType", "PrinterModelId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SlicerProfiles_PrinterModelId",
                table: "SlicerProfiles",
                column: "PrinterModelId");

            migrationBuilder.CreateIndex(
                name: "IX_SlicerProfiles_SlicerType",
                table: "SlicerProfiles",
                column: "SlicerType");

            migrationBuilder.CreateIndex(
                name: "IX_SlicerProfiles_SpecificPrinterId",
                table: "SlicerProfiles",
