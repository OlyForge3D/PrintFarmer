...
final class DemoJobService: JobServiceProtocol, @unchecked Sendable {
    ...
    private static let jobs: [PrintJob] = {
        ...
        return [
            // 3 printing
            decode("""
            {"id":"\(DemoData.job1ID)","status":"Printing","priority":"Normal","queuePosition":0,
            ...
            """),
            decode("""
            {"id":"\(DemoData.job2ID)","status":"Printing","priority":"Normal","queuePosition":0,
            ...
            """),
            decode("""
            {"id":"\(DemoData.job3ID)","status":"Printing","priority":"High","queuePosition":0,
            ...
            // 1 paused
            decode("""
            {"id":"\(DemoData.job4ID)","status":"Paused","priority":"Normal","queuePosition":0,
            ...
            // 2 queued
            decode("""
            {"id":"\(DemoData.job5ID)","status":"Queued","priority":"Normal","queuePosition":1,
            ...
            """),
            decode("""
            {"id":"\(DemoData.job6ID)","status":"Queued","priority":"Urgent","queuePosition":2,
            ...
            // 3 completed
            decode("""
            {"id":"\(DemoData.job7ID)","status":"Completed","priority":"Normal","queuePosition":0,
            ...
            """),
            decode("""
            {"id":"\(DemoData.job8ID)","status":"Completed","priority":"High","queuePosition":0,
            ...
            """),
            decode("""
            {"id":"\(UUID())","status":"Completed","priority":"Normal","queuePosition":0,
            ...
            // 2 failed
            decode("""
            {"id":"\(DemoData.job9ID)","status":"Failed","priority":"Normal","queuePosition":0,
            ...
            """),
            decode("""
            {"id":"\(DemoData.job10ID)","status":"Failed","priority":"Normal","queuePosition":0,
            ...
            // 1 cancelled
            decode("""
            {"id":"\(DemoData.job11ID)","status":"Cancelled","priority":"Low","queuePosition":0,
