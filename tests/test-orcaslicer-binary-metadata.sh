...
test_build_and_deploy_paths_enforce_metadata() {
    ...
    assert_contains "$publish_workflow" 'Worker__OrcaSlicerPath=/opt/orcaslicer/bin/orca-slicer' "Published workers should launch the real OrcaSlicer binary"
    ...
    assert_contains "$worker_compose" 'Worker__OrcaSlicerPath=/opt/orcaslicer/bin/orca-slicer' "Compose should launch the real OrcaSlicer binary"
